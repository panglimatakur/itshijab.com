<?php
session_start();
if(!defined('mainload')) { define('mainload','ADMIN',true); }
...
$base_url				= "";  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir 			= 'source/'; // path from base_url to base of upload folder (with start and final /)
$current_path 			= $basepath.'/libraries/tinymce/source/'; // relative path from filemanager folder to upload folder (with final /)
...
$default_language="id"; //default language file name
