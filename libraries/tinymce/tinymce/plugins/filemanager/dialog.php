...
<html xmlns="https://www.w3.org/1999/xhtml">
    ...
    <body>
    <input type="hidden" id="config" value='"dirhost":"<?php echo $dirhost; ?>","uidkey":"<?php echo $_SESSION['uidkey']; ?>"' />
	<input type="hidden" id="popup" value="<?php echo $popup; ?>" />
	<input type="hidden" id="view" value="<?php echo $view; ?>" />
	<input type="hidden" id="cur_dir" value="<?php echo $dirhost."/libraries/tinymce/".$cur_dir; ?>" />
...
<!----- header div end ------->
	...
	?>
        <li class="pull-right"><a class="btn-small" href="javascript:void('')" id="info">
        	<i class="icon-question-sign"></i></a>
        </li>
        <li class="pull-right"><a id="refresh" class="btn-small" href="dialog.php?<?php echo $get_params.$subdir."&".uniqid() ?>"><i class="icon-refresh"></i></a>
        </li>
