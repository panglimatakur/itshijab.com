            ...
            <div id="login" class="animate form">
                <section class="login_content">
                    <form method="POST" action="" name="form_login">
                        ...
                        <div>
                            <button type="submit" name="direction" value="login" class="btn btn-default submit">Log in</button>
                        ...
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Itshijab.com!</h1>

                                <p>©2017 All Rights Reserved. Itshijab.com is a Bootstrap 3 template. Privacy and Terms</p>
                            </div>
                        </div>
                    </form>
                    <!-- form -->
            ...
            <div id="register" class="animate form">
                <section class="login_content">
                    <form>
                        ...
                        <div>
                            <a class="btn btn-default submit" href="javascript:void();">Submit</a>
                        </div>
                        <div class="clearfix"></div>
                        <div class="separator">
                            ...
                            <br />
                            <div>
                                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> Itshijab!</h1>
