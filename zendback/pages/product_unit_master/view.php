...
<div class="col-md-12" >
    <div class="x_panel">
        <div class="x_title">
            <h2>Master <span class="title-highlight">Satuan</span></h2>
...
<div class="col-md-12" >
    <div class="x_panel">
        ...
        <div class="x_content">
            <div class="x_title">
                <h2>Daftar <span class="title-highlight">Satuan</span></h2>
                <div class="clearfix"></div>
            </div>
        ...
        <?php if($num_level > 0){ ?>
            <table width="100%" class="table table-data table-stripped table-bordered responsive-utilities jambo_table">
                ...
                <tbody>
                      ...
                      ?>
                      <tr id="tr_<?php echo $dt_level->ID_PRODUCT_UNIT; ?>">
                        <td><input type="checkbox" name="row_sel" class="row_sel" value='<?php echo $dt_level->ID_PRODUCT_UNIT; ?>'/></td>
                        <td><?php echo @$dt_level->NAME; ?></td>
                        <td style="text-align:center">
                            <div class="btn-group">
                                    <a href="<?php echo $lparam; ?>&direction=edit&no=<?php echo $dt_level->ID_PRODUCT_UNIT; ?>" class="btn btn-default" title="Edit">
                                        <i class="fa fa-pencil"></i>
                                    </a>
                                    <a href='javascript:void()' onclick="removal('<?php echo $dt_level->ID_PRODUCT_UNIT; ?>')" class="btn btn-default" title="Delete">
