$(document).ready(function(){		
	...
	$('#propinsi2').live('change',function(){
		data 		= $("#data_page").val();
		propinsi 	= $(this).val();
	...
	$("#select_rows").live("click",function(){
		ch = $(this).is(":checked");
		if(ch == true){
	...
	$("#select_rows_2").live("click",function(){
	...
	$("#delete_picked").live("click",function(){
